...
public class AccountKeysListTest {
    ...
    public void getSortedList() {
        ...
        assertEquals("8VBafTNv1F8k5Bg7DTVwhitw3MGAMTmekHsgLuMJxLC8", accountKeysList.get(1).getPublicKey().toBase58());
        assertEquals("7ytmC1nT1xY4RfxCV2ZgyA7UakC93do5ZdyhdF3EtPj7", accountKeysList.get(2).getPublicKey().toBase58());
        assertEquals("SysvarRent111111111111111111111111111111111", accountKeysList.get(3).getPublicKey().toBase58());
        assertEquals("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA", accountKeysList.get(4).getPublicKey().toBase58());
        assertEquals("11111111111111111111111111111111", accountKeysList.get(5).getPublicKey().toBase58());
        assertEquals("6Cust2JhvweKLh4CVo1dt21s2PJ86uNGkziudpkNPaCj", accountKeysList.get(6).getPublicKey().toBase58());
        assertEquals("3gF2KMe9KiC6FNVBmfg9i267aMPvK37FewCip4eGBFcT", accountKeysList.get(7).getPublicKey().toBase58());
        assertEquals("HwRVBufQ4haG5XSgpspwKtNd3PC9GM9m1196uJW36vds", accountKeysList.get(8).getPublicKey().toBase58());
